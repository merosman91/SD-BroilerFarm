...
const SplashScreen = ({ onFinish, duration = 4000 }) => {
    ...
    const features = [
        { icon: Feather, title: "إدارة متكاملة", description: "إدارة كاملة لمزرعة الدواجن", color: "from-blue-500 to-cyan-500" },
        { icon: Database, title: "مخزون لكل دورة", description: "كل دورة لها مخزونها الخاص", color: "from-green-500 to-emerald-500" },
        { icon: TrendingUp, title: "تقارير ذكية", description: "تحليل أداء دقيق", color: "from-purple-500 to-violet-500" },
        { icon: Shield, title: "نظام آمن", description: "حماية بيانات مزرعتك", color: "from-orange-500 to-amber-500" },
        { icon: Smartphone, title: "متجاوب مع الهواتف", description: "عمل على جميع الأجهزة", color: "from-indigo-500 to-blue-500" }
    ];
    ...
    return (
        <div className="fixed inset-0 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 z-50 flex flex-col items-center justify-center overflow-hidden">
            ...
            <div className="relative mb-6">
                <h1 className="text-4xl md:text-5xl font-bold text-white mb-2 text-center drop-shadow-2xl">
                    دواجني
                </h1>
                    ...
                    <div className={`bg-gradient-to-r ${currentFeatureData.color} p-6 rounded-2xl shadow-2xl border border-white/20 backdrop-blur-sm`}>
                        <div className="flex items-center gap-4 mb-4">
                            ...
                            <div className="text-right flex-1">
                                <h3 className="text-xl font-bold text-white mb-1">{currentFeatureData.title}</h3>
            ...
            <div className="w-full max-w-xs mb-12 px-4">
                ...
                <div className="w-full h-3 bg-white/20 rounded-full overflow-hidden backdrop-blur-sm relative">
                    <div 
                        className="h-full bg-gradient-to-r from-orange-500 to-red-500 rounded-full transition-all duration-300 shadow-lg relative"
                ...
                <div className="bg-gradient-to-r from-gray-800/50 to-gray-900/50 backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-2xl">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="text-right">
                            <div className="text-white font-bold text-lg mb-1">ميرغني أبوالقاسم</div>
                            <div className="text-white/80 text-sm mb-3">مطور نظم معلومات وتطبيقات ويب</div>
                            <div className="flex gap-3">
                                <div className="text-xs px-3 py-1 bg-white/20 rounded-full text-white/90 backdrop-blur-sm">الإصدار 2.0.0</div>
                                <div className="text-xs px-3 py-1 bg-white/20 rounded-full text-white/90 backdrop-blur-sm">© {new Date().getFullYear()}</div>
                            </div>
                        </div>
                    </div>
            ...
            <div className="absolute bottom-4 left-0 right-0 text-center">
                <div className="text-white/40 text-xs">تذكر: البيانات المحفوظة تظل على جهازك فقط</div>
            </div>
        </div>
    );
};
